...
Begin VB.Form surat_lembur 
   ...
   Begin VB.Frame Frame3 
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "surat_lembur.frx":2A05A
         Height          =   5775
         Left            =   240
         TabIndex        =   47
         Top             =   2040
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.CommandButton Command7 
         BackColor       =   &H0000FFFF&
         Cancel          =   -1  'True
         Caption         =   "CETAK DATA SURAT LEMBUR"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   9.75
            Charset         =   0
      ...
      Begin VB.Label Label18 
         ...
         Caption         =   "FORM PENGISIAN SURAT LEMBUR"
         BeginProperty Font 
            Name            =   "Arial Black"
            Size            =   18
            Charset         =   0
   ...
   End
End
Attribute VB_Name = "surat_lembur"
...
Adodc1.Recordset!alasan = Text10.Text
Adodc1.Recordset!tanggal = DTPicker1.Value
Adodc1.Recordset!jam_mulai = DTPicker3.Value
Adodc1.Recordset!jam_selesai = DTPicker4.Value
...
Text10.Text = Adodc1.Recordset!alasan
DTPicker1.Value = Adodc1.Recordset!tanggal
DTPicker3.Value = Adodc1.Recordset!jam_mulai
DTPicker4.Value = Adodc1.Recordset!jam_selesai
...
Else
With cr1
    .SelectionFormula = "{lembur.nomor}='" & Text1.Text & "'"
    .ReportFileName = App.Path & "\surat_lembur.rpt"
